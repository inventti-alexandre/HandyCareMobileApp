namespace handycareappService.Migrations
{
    ...
    public partial class InserirTables : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.TipoContato", "CreatedAt", c => c.DateTimeOffset(nullable: false, precision: 7));
            AddColumn("dbo.TipoContato", "UpdatedAt", c => c.DateTimeOffset(nullable: false, precision: 7));
            AddColumn("dbo.TipoContato", "Version", c => c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"));
            AddColumn("dbo.TipoContato", "Deleted", c => c.Boolean(nullable: true));
        }
