namespace handycareappService.Migrations
{
    ...
    public partial class CoisaDoAzure1 : DbMigration
    {
        public override void Up()
        {
            ...
            AddColumn("dbo.Material", "CreatedAt", c => c.DateTimeOffset(nullable: false, precision: 7));
            AddColumn("dbo.Material", "UpdatedAt", c => c.DateTimeOffset(nullable: false, precision: 7));
            AddColumn("dbo.Material", "Version", c => c.Binary(nullable: false, fixedLength: true, timestamp: true, storeType: "rowversion"));
            AddColumn("dbo.Material", "Deleted", c => c.Boolean(nullable: true));
        }
